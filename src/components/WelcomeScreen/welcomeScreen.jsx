  ...
  return (
    <div className="welcome-screen-container">
      <div className="welcome-screen-text">
        ...
        <p>I’m a recent graduate in Frontend Development, and I’m thrilled to share my rendition of the classic 15-puzzle game with you. I’m passionate about building user-friendly, modern web applications.</p>
